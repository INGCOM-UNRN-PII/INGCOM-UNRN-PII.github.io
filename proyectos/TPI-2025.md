---
title: "Trabajo Integrador Final 2025"
description: Consignas y rúbrica del Trabajo Integrador Final de Programación II.
---
...
:::{tip}
Es vital para quienes elijan esta opción, que nos sentemos a conversar sobre la idea, cosa de que luego no sufran por su elección. Para esto, tengan _escrita_ la idea en el `README.md` y, si es posible, con un boceto del diagrama de clases que implementarán y una breve justificación de por qué eligieron desarrollar la idea.
