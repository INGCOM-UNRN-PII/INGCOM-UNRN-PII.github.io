...
Acá no hace falta integrar el entorno, lo vamos a usar desde proyecto por lo que
abrir esto que es bastante pesado para editar archivos individuales es un medio
excesivo.
...
### Paso 7
Aquí verán todos los repositorios en los que tienen acceso, propios y los que son administrados por la cátedra.
